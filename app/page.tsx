...
export default function Home() {
  return (
    <div className="mainContainer 2xl:container mx-auto p-2">
      
      <div className="grid grid-cols-3 md:grid-cols-5 grid-rows-12 md:grid-rows-9 gap-2">
        <div className="superDiv col-span-3 md:col-span-5 bg-red-600">Menu</div>
        ...
        <div className="superDiv hidden md:block md:row-span-2 col-start-3 md:row-start-2">Current Month</div>
        <div className="superDiv hidden md:block row-span-2 col-start-4 md:row-start-2">Current Month +1</div>
        <div className="superDiv hidden md:block row-span-2 col-start-5 md:row-start-2">Current Month +2</div>
        ...
        <div className="superDiv row-span-2 row-start-2 md:row-start-4">Sharpen the Saw</div>
